...
> 📎 **Supplementary Material**: The supplementary document for this paper is available at [`Appedix/Appendix.pdf`](Appedix/Appendix.pdf).
...
│
├── Appedix/
│   └── Appendix.pdf            # Supplementary material for the paper
│
└── demo/
